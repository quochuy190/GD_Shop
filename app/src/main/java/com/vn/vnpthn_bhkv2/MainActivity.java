...
import com.vn.vnpthn_bhkv2.activity.login.ActivityIntroduce;
import com.vn.vnpthn_bhkv2.activity.login.InterfaceLogin;
import com.vn.vnpthn_bhkv2.activity.login.PresenterLogin;
import com.vn.vnpthn_bhkv2.activity.notify.ActivityNotify;
import com.vn.vnpthn_bhkv2.activity.notify.InterfaceNotify;
import com.vn.vnpthn_bhkv2.activity.notify.PresenterNotify;
import com.vn.vnpthn_bhkv2.activity.products.ActivityCart;
...
import com.vn.vnpthn_bhkv2.fragment.FragmentCommissionCTV;
import com.vn.vnpthn_bhkv2.fragment.FragmentCommissionsHome;
import com.vn.vnpthn_bhkv2.fragment.FragmentHome;
import com.vn.vnpthn_bhkv2.fragment.FragmentOrder;
import com.vn.vnpthn_bhkv2.fragment.FragmentProduct;
import com.vn.vnpthn_bhkv2.fragment.left_menu.ctv.FragmentLeftMenu;
import com.vn.vnpthn_bhkv2.models.ErrorApi;
import com.vn.vnpthn_bhkv2.models.ListBankName;
...
public class MainActivity extends BaseActivity
    ...
    private void set_badger_noti(int count) {
        ...
        if (mObjLogin.getGROUPS().equals(Config.GROUP_CONGTACVIEN)
                || objLogin.getGROUPS().equals(Config.GROUP_KHACHHANG)) {
            ic_notify_appbar.setVisibility(View.VISIBLE);
            ic_cart_appbar.setVisibility(View.VISIBLE);
        } else {
            ic_notify_appbar.setVisibility(View.VISIBLE);
    ...
    private void initEvent() {
        ic_zalo_main.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.setData(Uri.parse("https://zalo.me/586105194158721229?src=qr"));
                ...
                case R.id.navigation_bonus:
                    ...
                    if (isLogin) {
                        if (objLogin != null && objLogin.getGROUPS() != null) {
                            if (objLogin.getGROUPS().equals(Config.GROUP_CONGTACVIEN) ||
                                    objLogin.getGROUPS().equals(Config.GROUP_KHACHHANG)) {
                                ...
                                loadFragment_HH_CTV();
                            } else if (objLogin != null && objLogin.getGROUPS()
                                    != null && objLogin.getGROUPS().equals("3")) {
                                MainActivity.edt_search_main.setVisibility(View.GONE);
                                //   MainActivity.txt_title_main.setVisibility(View.VISIBLE);
                                MainActivity.txt_title_main.setText("Hoa hồng");
                                loadFragmentSetup();
