...
import com.vn.vnpthn_bhkv2.activity.login.ActivityConfirmOTP;
import com.vn.vnpthn_bhkv2.activity.tintuc.ActivityDetailNews;
import com.vn.vnpthn_bhkv2.adapter.AdapterImaViewPager;
import com.vn.vnpthn_bhkv2.adapter.AdapterImageUpFace;
import com.vn.vnpthn_bhkv2.adapter.AdapterImage_Zoom_Viewpage;
import com.vn.vnpthn_bhkv2.adapter.AdapterViewpager;
import com.vn.vnpthn_bhkv2.adapter.ImageAdapter;
...
import com.vn.vnpthn_bhkv2.callback.TaskCompleted;
...
/*    @BindView(R.id.ll_tab_layout_face)
    ...
    @BindView(R.id.tx_commission_max)
    TextView tx_commission_max;
   ...
   /* @Override
            ...
            if (objLogin != null && objLogin.getGROUPS() != null) {
                if (objLogin.getGROUPS().equals("5") ||
                    ...
                    if (objLogin.getGROUPS().equals("8")) {
                        ...
                        tx_commission_max.setVisibility(View.GONE);
                        ...
                        tx_commission_max.setVisibility(View.VISIBLE);
    ...
    public void set_commission_max(long lPrice) {
        ...
        if (mProduct.getCOMISSION_PRODUCT() != null && mProduct.getCOMISSION_PRODUCT().length() > 0) {
            commis_product = Float.parseFloat(mProduct.getCOMISSION_PRODUCT().replace(",","."));
        }
        ...
        String sVersionCode = "Hoa hồng tối đa: "
                ...
                "%)</font>";
        tx_commission_max.setText(Html.fromHtml(sVersionCode), TextView.BufferType.SPANNABLE);
    }

    private void set_hh_sp(String sCommission, String sPrice, TextView txt_com) {
        try {
            float commission = Float.parseFloat(sCommission.replace(",", "."));
