package com.vn.vnpthn_bhkv2.config;
...
public class Constants {
    public class RequestCode {
        ...
        public static final int GET_UPDATE_CTV = 1008;
        public static final int GET_LOGIN_BUY= 1009;
    }
    public class EventBus {
        ...
        public static final String KEY_LOGIN_GUEST = "KEY_LOGIN_GUEST";
    }
    public class User_Group_Type{
        public static final String ADMIN = "0";
        public static final String CTV = "5";
        public static final String SHOP = "3";
        public static final String BIEN_TAP_VIEN = "6";
        public static final String DAI_LY = "7";
        public static final String KHACH_HANG = "8";
    }
    ...
    public static final String KEY_SAVE_IS_CHECK_DEVICE = "KEY_SAVE_IS_CHECK_DEVICE";
    ...
    public static final String KEY_SEND_LOGIN_GUEST = "KEY_SEND_LOGIN_GUEST";
}
